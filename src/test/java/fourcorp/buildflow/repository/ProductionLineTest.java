...
class ProductionLineTest {
    ...
    void newOrder() {
        ...
        p1.newOrder(o1, Integer.valueOf(1));
        p1.newOrder(o2, Integer.valueOf(2));
        p1.newOrder(o3, Integer.valueOf(1));
        p1.newOrder(o4, Integer.valueOf(3));

        List<Order> ordersPriority1 = p1.getOrdersByPriority(Integer.valueOf(1));
        List<Order> ordersPriority2 = p1.getOrdersByPriority(Integer.valueOf(2));
        List<Order> ordersPriority3 = p1.getOrdersByPriority(Integer.valueOf(3));
    ...
    void removeOrderFromPL() {
        ...
        ProductionLine p2 = new ProductionLine();
        p2.newOrder(o1, Integer.valueOf(1));

        List<Order> ordersPriority1 = p2.getOrdersByPriority(Integer.valueOf(1));

        p2.removeOrderFromPL(o1.getId());

        List<Order> ordersPriority2 = p2.getOrdersByPriority(Integer.valueOf(1));
    ...
    void searchOrder() {
        ...
        assertTrue(p2.searchOrder(o1.getId()).getId().equals(o1.getId()));
    }
}