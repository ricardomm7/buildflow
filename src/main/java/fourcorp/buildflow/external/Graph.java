...
public interface Graph<V, E> extends Cloneable {
     ...
     * @return the edge from vOrig to vDest, or null if vertices are not adjacent
     */
    Edge<V> edge(int vOrigKey, int vDestKey);
     ...
     */
    Collection<Edge<V>> outgoingEdges(V vert);
     ...
     */
    Collection<Edge<V>> incomingEdges(V vert);
     ...
     */
    boolean addEdge(V vOrig, V vDest);
