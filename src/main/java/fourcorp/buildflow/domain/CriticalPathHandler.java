...
public class CriticalPathHandler {
    ...
    public CriticalPathHandler() {
        // Prioridade com base na profundidade em ordem decrescente
        criticalPathQueue = new PriorityQueue<>((node1, node2) -> Integer.compare(node2.getDepth(), node1.getDepth()));
    }

    public void addOperationToCriticalPath(ProductionNode node) {
        criticalPathQueue.add(node);
    }
