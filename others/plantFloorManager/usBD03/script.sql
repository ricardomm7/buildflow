...
CREATE TABLE Costumer (VAT varchar2(20) NOT NULL, Name varchar2(255) NOT NULL, Address varchar2(60) NOT NULL, "Zip-Code" varchar2(10) NOT NULL, City varchar2(60) NOT NULL, Country varchar2(60) NOT NULL, PRIMARY KEY (VAT));
CREATE TABLE Operation (Operation_ID number(10) GENERATED AS IDENTITY, Designation varchar2(60) NOT NULL, BOOProduct_FamilyFamily_ID varchar2(60) NOT NULL, BOOOperation_Sequence number(10) NOT NULL, PRIMARY KEY (Operation_ID));
...
CREATE TABLE Part (Part_ID char(10) NOT NULL, Descriprion varchar2(100) NOT NULL, PRIMARY KEY (Part_ID));
...
CREATE TABLE Type_Workstation (WorkstationType_ID char(5) NOT NULL, Designation varchar2(60) NOT NULL, OperationOperation_ID number(10) NOT NULL, PRIMARY KEY (WorkstationType_ID));
CREATE TABLE Workstation (Workstation_ID number(4) GENERATED AS IDENTITY, Name varchar2(60) NOT NULL, Description varchar2(100) NOT NULL, Type_WorkstationWorkstationType_ID char(5) NOT NULL, PRIMARY KEY (Workstation_ID));
...
ALTER TABLE Type_Workstation ADD CONSTRAINT FKType_Works901323 FOREIGN KEY (OperationOperation_ID) REFERENCES Operation (Operation_ID);
