...
CREATE TABLE External_Part (Part_ID char(10) NOT NULL, Minimum_Stock number(10) NOT NULL, PRIMARY KEY (Part_ID));
CREATE TABLE Intermediate_Product (Part_ID char(10) NOT NULL, PRIMARY KEY (Part_ID));
CREATE TABLE Operation (Operation_ID number(10) NOT NULL, Designation varchar2(100) NOT NULL, NextOperation_ID number(10), Product_ID char(10) NOT NULL, Expected_Time double precision NOT NULL, Output_Part_ID char(10) NOT NULL, PRIMARY KEY (Operation_ID));
